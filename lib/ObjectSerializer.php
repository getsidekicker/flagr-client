...
use Flagr\Client\Model\ModelInterface;
...
class ObjectSerializer
{
        ...
        if (is_object($data)) {
            ...
            if ($data instanceof ModelInterface) {
                ...
                foreach ($data::openAPITypes() as $property => $openAPIType) {
                    ...
                    $value = $data->$getter();
                    if ($value !== null && !in_array($openAPIType, [\DateTime::class, \SplFileObject::class, 'array', 'bool', 'boolean', 'byte', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], true)) {
    ...
    public static function toQueryValue(
        ...
        if ($openApiType === \DateTime::class && $value instanceof \DateTime) {
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (in_array($class, [\DateTime::class, \SplFileObject::class, 'array', 'bool', 'boolean', 'byte', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], true)) {
            settype($data, $class);
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Flagr\Client\Model\\' . $data->{$discriminator};
