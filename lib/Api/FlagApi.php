...
class FlagApi
{
    ...
    public function findFlagsRequest($limit = null, $enabled = null, $description = null, $tags = null, $description_like = null, $key = null, $offset = null, $preload = null, $deleted = null)
    {
        ...
        // query params
        if (is_array($enabled)) {
            $enabled = ObjectSerializer::serializeCollection($enabled, '', true);
        }
        if ($enabled !== null) {
        ...
        if (is_array($description_like)) {
            $description_like = ObjectSerializer::serializeCollection($description_like, '', true);
        }
        if ($description_like !== null) {
            $queryParams['description_like'] = $description_like;
        }
        // query params
        if (is_array($key)) {
        ...
        // query params
        if (is_array($preload)) {
            $preload = ObjectSerializer::serializeCollection($preload, '', true);
        }
        if ($preload !== null) {
            $queryParams['preload'] = $preload;
        }
        // query params
        if (is_array($deleted)) {
            $deleted = ObjectSerializer::serializeCollection($deleted, '', true);
        }
        if ($deleted !== null) {
