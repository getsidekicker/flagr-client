...
class ExportApi
{
    ...
    public function getExportSqliteRequest($exclude_snapshots = null)
    {
        ...
        // query params
        if (is_array($exclude_snapshots)) {
            $exclude_snapshots = ObjectSerializer::serializeCollection($exclude_snapshots, '', true);
        }
        if ($exclude_snapshots !== null) {
            $queryParams['exclude_snapshots'] = $exclude_snapshots;
        }
