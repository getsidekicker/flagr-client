...
class HealthApi
{
     ...
     * @return \Flagr\Client\Model\Health|\Flagr\Client\Model\Error
     */
    public function getHealth(string $contentType = self::contentTypes['getHealth'][0])
    {
        [$response] = $this->getHealthWithHttpInfo($contentType);
     ...
     * @throws \Flagr\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flagr\Client\Model\Health|\Flagr\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHealthWithHttpInfo(string $contentType = self::contentTypes['getHealth'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (\Flagr\Client\Model\Health::class === \SplFileObject::class) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if (\Flagr\Client\Model\Health::class !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, \Flagr\Client\Model\Health::class, []),
            ...
            $returnType = \Flagr\Client\Model\Health::class;
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        \Flagr\Client\Model\Health::class,
