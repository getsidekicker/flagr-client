...
class ConstraintApi
{
    ...
    {
        [$response] = $this->createConstraintWithHttpInfo($flag_id, $segment_id, $body);
     ...
     */
    public function createConstraintRequest($flag_id, $segment_id, $body)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteConstraintRequest($flag_id, $segment_id, $constraint_id)
    {
        // verify the required parameter 'flag_id' is set
        if ($flag_id === null || (is_array($flag_id) && count($flag_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        [$response] = $this->findConstraintsWithHttpInfo($flag_id, $segment_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findConstraintsRequest($flag_id, $segment_id)
    {
        // verify the required parameter 'flag_id' is set
        if ($flag_id === null || (is_array($flag_id) && count($flag_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        [$response] = $this->putConstraintWithHttpInfo($flag_id, $segment_id, $constraint_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putConstraintRequest($flag_id, $segment_id, $constraint_id, $body)
    {
        // verify the required parameter 'flag_id' is set
        if ($flag_id === null || (is_array($flag_id) && count($flag_id) === 0)) {
            throw new \InvalidArgumentException(
