 ...
 */
class EvalDebugLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'evalDebugLog';
    ...
    {
        $this->setIfExists('segment_debug_logs', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Flagr\Client\Model\SegmentDebugLog[]|null
     */
     ...
     *
     * @param \Flagr\Client\Model\SegmentDebugLog[]|null $segment_debug_logs segment_debug_logs
     *
     * @return self
     */
    public function setSegmentDebugLogs($segment_debug_logs)
    {
        if (is_null($segment_debug_logs)) {
            throw new \InvalidArgumentException('non-nullable segment_debug_logs cannot be null');
        }
