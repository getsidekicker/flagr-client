 ...
 */
class EvaluationBatchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'evaluationBatchResponse';
    ...
    {
        $this->setIfExists('evaluation_results', $data ?? [], null);
    }
    ...
    */
    ...
    public function setEvaluationResults($evaluation_results)
    {
        if (is_null($evaluation_results)) {
            throw new \InvalidArgumentException('non-nullable evaluation_results cannot be null');
        }
