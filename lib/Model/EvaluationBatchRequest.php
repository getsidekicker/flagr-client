...
class EvaluationBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['flag_ids'] = $data['flag_ids'] ?? null;
        $this->container['flag_keys'] = $data['flag_keys'] ?? null;
        $this->container['flag_tags'] = $data['flag_tags'] ?? null;
        $this->container['flag_tags_operator'] = $data['flag_tags_operator'] ?? 'ANY';
    }
    ...
    {
        if (!is_null($flag_ids) && (count($flag_ids) < 1)) {
    ...
    {
        if (!is_null($flag_keys) && (count($flag_keys) < 1)) {
    ...
    {
        if (!is_null($flag_tags) && (count($flag_tags) < 1)) {
