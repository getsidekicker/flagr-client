...
class Configuration
{
    ...
    private static ?\Flagr\Client\Configuration $defaultConfiguration = null;
    ...
    {
        $report  = 'PHP SDK (Flagr\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.14' . PHP_EOL;
